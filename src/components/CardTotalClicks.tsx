...
import { MousePointerClick, ArrowUp, ArrowDown } from 'lucide-react';

const CardTotalClicks = () => {
  const { accountData } = useData();
  const totalClicks = accountData.totalClicks;
  const percentageChange = ((accountData.totalClicks - accountData.totalClicksLastMonth) / accountData.totalClicksLastMonth) * 100;
...
export default CardTotalClicks;
